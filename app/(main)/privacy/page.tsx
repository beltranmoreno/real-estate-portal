      ...
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="bg-white rounded-lg shadow-sm p-8 md:p-12">
          ...
          <div className="text-center mb-12">
            <div className="w-16 h-16 bg-brand-wash rounded-full flex items-center justify-center mx-auto mb-6">
          ...
          <div className="prose prose-slate max-w-none">
            <div className="space-y-8">
              ...
              <section>
                ...
                <p className="text-body-strong mb-4">
                  {t({
                ...
                <ul className="list-disc pl-6 text-body-strong space-y-2">
              ...
              {/* Contact */}
              <section className="bg-canvas rounded-lg p-6">
                ...
                <p className="text-ink font-medium mt-2">leticiacoudrayrealestate@gmail.com</p>
              </section>
            </div>
          </div>
        </div>
